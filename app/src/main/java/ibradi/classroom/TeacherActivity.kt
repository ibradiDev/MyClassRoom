...
import ibradi.classroom.components.teacher.TeacherHomeScreen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            LaunchedEffect(firebaseUser) {
                ...
                if (!isLoggedIn) {
                    val intent = Intent(this@TeacherActivity, AuthActivity::class.java)
            ...
            MyClassRoomTheme {
                NavHost(
                    ...
                    composable("home") { TeacherHomeScreen() }
